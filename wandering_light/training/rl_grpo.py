                ...
                if result:
                    if self.task == Task.INDUCTION:
                        ...
                        eval_result = {
                            ...
                            "unique_function_sequences": len(unique_function_sequences),
                        }
                        self.eval_results.append(eval_result)
...
def rl_grpo_main(
    ...
    model=None,
    full_run: bool = False,
    eval_steps: int = RLGRPOConfig.DEFAULT_EVAL_STEPS,
    eval_samples: int | None = None,
    num_train_epochs: int = RLGRPOConfig.DEFAULT_NUM_EPOCHS,
    learning_rate: float = RLGRPOConfig.DEFAULT_LEARNING_RATE,
    max_length: int = RLGRPOConfig.DEFAULT_MAX_LENGTH,
    per_device_train_batch_size: int = RLGRPOConfig.DEFAULT_BATCH_SIZE,
    wandb_project: str = "wandering-light-rl",
    wandb_run_name: str | None = None,
    length_penalty_strength: float = RLGRPOConfig.DEFAULT_LENGTH_PENALTY,
    task: Task = Task.INDUCTION,
